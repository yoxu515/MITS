...
# training MITS with masks from VOS datasets and boxes from VOT datasets
class EngineConfig(DefaultEngineConfig):
    def __init__(self, exp_name='default', model='R50_MITS',stage='default'):
        ...
        if self.STAGE_NAME == 'PRE':
            ...
            self.DATASETS = ['youtubevos', 'davis2017', 'lasot', 'got10k']
            ...
            self.TRAIN_WITH_BOX = True
            self.DATA_LASOT_BOX_LABEL = True
            self.DATA_GOT10K_BOX_LABEL = True
            ...
            self.TRAIN_BCE_LOSS_WEIGHT = 0.75
            self.TRAIN_IOU_LOSS_WEIGHT = 0.75
            ...
            self.TRAIN_BOX_L1_LOSS_WEIGHT = 1.0
            self.TRAIN_BOX_GIOU_LOSS_WEIGHT = 0.5
